...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t3, kysymys1, vaihtoehdot2, kysymys2, vaihtoehdot3, kysymys3, _s6_ = "teksti",
        _s11_ = "vaihtoehdot",
        kysymykset = [], vaihtoehdot1 = [],
        t1 = type$.legacy_String,
        t2 = type$.legacy_Object;
      vaihtoehdot1.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "1+3", "oikein", true], t1, t2));
      vaihtoehdot1.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "3--2", "oikein", false], t1, t2));
      vaihtoehdot1.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "3", "oikein", false], t1, t2));
      t3 = type$.dynamic;
      kysymys1 = A.LinkedHashMap_LinkedHashMap$_empty(t3, t3);
      kysymys1.$indexSet(0, _s6_, "Paljonko on 2+2?");
      kysymys1.$indexSet(0, _s11_, vaihtoehdot1);
      kysymykset.push(kysymys1);
      vaihtoehdot2 = [];
      vaihtoehdot2.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "7", "oikein", false], t1, t2));
      vaihtoehdot2.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "9-7", "oikein", true], t1, t2));
      vaihtoehdot2.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "3+(-5)", "oikein", false], t1, t2));
      kysymys2 = A.LinkedHashMap_LinkedHashMap$_empty(t3, t3);
      kysymys2.$indexSet(0, _s6_, "Paljonko on 5-3?");
      kysymys2.$indexSet(0, _s11_, vaihtoehdot2);
      kysymykset.push(kysymys2);
      vaihtoehdot3 = [];
      vaihtoehdot3.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "182", "oikein", false], t1, t2));
      vaihtoehdot3.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "30", "oikein", false], t1, t2));
      vaihtoehdot3.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "50-15", "oikein", true], t1, t2));
      kysymys3 = A.LinkedHashMap_LinkedHashMap$_empty(t3, t3);
      kysymys3.$indexSet(0, _s6_, "Paljonko on 7*5?");
      kysymys3.$indexSet(0, _s11_, vaihtoehdot3);
      kysymykset.push(kysymys3);
      vaihtoehdot3 = J.get$onClick$x(document.querySelector("#seuraava"));
      t3 = vaihtoehdot3.$ti;
      t2 = t3._eval$1("~(1)?")._as(new A.main_closure(kysymykset));
      type$.nullable_void_Function._as(null);
      A._EventStreamSubscription$(vaihtoehdot3._target, vaihtoehdot3._eventType, t2, false, t3._precomputed1);
    },
